...
{
    [CustomPropertyDrawer(typeof(ConverterSettings))]
    internal class ConverterSettingsPropertyDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if(GUI.enabled)
            {
                GUI.enabled = type.Assembly != typeof(Dimension).Assembly;
