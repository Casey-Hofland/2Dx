...
{
    public static class Box2DxTools
    {
        /// <include file='../Documentation.xml' path='docs/Box2DxTools/IsBox/*'/>
        ...
        /// <include file='../Documentation.xml' path='docs/Box2DxTools/CreateBox/*'/>
        ...
        /// <include file='../Documentation.xml' path='docs/Box2DxTools/Box2D/*'/>
