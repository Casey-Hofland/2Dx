...
{
    [Obsolete("This class is being replaces by the new Module2Dx.", false)]
    public abstract class Module2DxOld : MonoBehaviour
    {
        #region Static Collection
        private static SortedDictionary<int, SortedDictionary<uint, HashSet<Module2DxOld>>> orderedBatches = new SortedDictionary<int, SortedDictionary<uint, HashSet<Module2DxOld>>>();
        ...
        {
            orderedBatches = new SortedDictionary<int, SortedDictionary<uint, HashSet<Module2DxOld>>>();
        }
        #endregion
        ...
        protected virtual void Awake()
        {
            ...
            {
                orderedBatches.Add(conversionOrder, new SortedDictionary<uint, HashSet<Module2DxOld>>());
            }
            if(!orderedBatches[conversionOrder].ContainsKey(clampedBatchSize))
            {
                orderedBatches[conversionOrder].Add(clampedBatchSize, new HashSet<Module2DxOld>());
            }
        }
