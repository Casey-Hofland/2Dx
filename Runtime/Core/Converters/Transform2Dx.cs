...
namespace Unity2Dx
{
    ...
    [ExecuteAlways]
    public class Transform2Dx : MonoBehaviour, ISerializationCallbackReceiver
    {
        #region Properties
        ...
        /// <include file='../Documentation.xml' path='docs/Transform2Dx/gameObject3D/*' />
        public GameObject gameObject3D { get; private set; }
        /// <include file='../Documentation.xml' path='docs/Transform2Dx/transform3D/*' />
        public Transform transform3D => gameObject3D.transform;

        /// <include file='../Documentation.xml' path='docs/Transform2Dx/gameObject2D/*' />
        public GameObject gameObject2D { get; private set; }
        /// <include file='../Documentation.xml' path='docs/Transform2Dx/transform2D/*' />
        public Transform transform2D => gameObject2D.transform;

        /// <include file='../Documentation.xml' path='docs/Transform2Dx/updateMode/*' />
        ...
        /// <include file='../Documentation.xml' path='docs/Transform2Dx/convert/*' />
        public bool convert
        {
            get => _convert;
            set
