...
{
    public static class BoxConverterTools
    {
        /// <include file='../Documentation.xml' path='docs/BoxConverterTools/IsBox/*'/>
        ...
        /// <include file='../Documentation.xml' path='docs/BoxConverterTools/CreateBox/*'/>
        ...
        /// <include file='../Documentation.xml' path='docs/BoxConverterTools/Box2D/*'/>
